...
urlpatterns = [
    ...
    path('creer_animals/', login_required(views.CreateAnimal.as_view()), name="creer_animal"),
    path('modifier_animal/<int:pk>/', login_required(views.UpdateAnimal.as_view()), name="modifier_animal"),
    ...
    path('creer_sejour/', login_required(views.CreateSejour.as_view()), name="creer_sejour"),
    path('modifier_sejour/<int:pk>/', login_required(views.UpdateSejour.as_view()), name="modifier_sejour"),
    ...
    path('creer_visite/', login_required(views.CreateVisite.as_view()), name="creer_visite"),
